...
import { Code2, BookOpen, PlusCircle, Users, BarChart2, Video, X, FileText, CheckSquare, Megaphone } from 'lucide-react';

const TEACHER_NAV = [
  { href: '/teacher/dashboard', label: 'Dashboard', icon: BarChart2 },
  { href: '/teacher/courses', label: 'My Courses', icon: BookOpen },
  { href: '/teacher/exams', label: 'Exams & Quizzes', icon: FileText },
  { href: '/teacher/homework', label: 'Homework & Grading', icon: CheckSquare },
    ...
    <>
      ...
      >
        ...
        <div suppressHydrationWarning className="border-t border-border/40 p-4">
          <p className="text-[10px] text-muted-foreground text-center">Teacher Hub v1.0</p>
        </div>
      </aside>
    </>
  );
